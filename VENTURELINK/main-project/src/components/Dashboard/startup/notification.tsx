...
//   //   // Step 2: If not found, try localStorage (optional)
//   //   if (!storedId || storedId === 'null') {
//   //     const storedUser = localStorage.getItem('users2');
//   //     try {
//   //       const parsed = storedUser ? JSON.parse(storedUser) : null;
//   //       storedId = parsed?.id?.toString() ?? '';
//   //     } catch (err) {
//   //       console.error('❌ Failed to parse users2 from localStorage:', err);
//   //     }

//   //     // Optional: prompt fallback
//   //     if (!storedId) {
//   //       storedId = prompt('Enter your user ID:') ?? '';
//   //     }
