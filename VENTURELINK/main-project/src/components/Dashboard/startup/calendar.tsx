...
//           <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">Investor Calendar</h1>
//           <p className="text-gray-600 dark:text-gray-400">Schedule and manage your investor meetings</p>
//         </div>
