...
// import { FaArrowRight, FaRocket, FaBullhorn, FaHandHoldingUsd } from 'react-icons/fa'; // Icons
...
//     // Sample data for current fields in demand and tips for investors
...
//       >
//         {loading ? (
//           <p className="text-xl text-gray-500">Loading your data...</p>
//         ) : (
//           <div>
//             <p className="text-xl font-semibold text-gray-800">Hello, {user?.full_name || 'Investor'}! 👋</p>
//           </div>
//         )}
//       </motion.section>
...
//       >
//         <h3 className="text-3xl font-semibold text-center text-gray-800 mb-6">Fields Currently in Demand</h3>
...
//               <FaArrowRight className="text-indigo-600 text-2xl" />
//               <span className="text-lg font-medium text-gray-800">{field}</span>
//             </div>
//           </motion.div>
//         ))}
//       </motion.section>
...
//       >
//         <h3 className="text-3xl font-semibold text-center text-gray-800 mb-6">Investor Tips</h3>
//         {tips.map((tip, index) => (
//           <motion.div
//             key={index}
//             className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300"
...
//               <span className="text-lg font-medium text-gray-800">{tip}</span>
//             </div>
//           </motion.div>
//         ))}
//       </motion.section>
...
//           Explore Gamified Investment Opportunities
//         </a>
//       </motion.section>
//     </div>
//   );
          ...
          {loading ? (
            ...
            <div className="inline-block bg-white px-6 py-4 rounded-full shadow-sm">
              <h2 className="text-2xl font-semibold text-gray-800">
                Welcome back, <span className="text-indigo-600">{user?.full_name || 'Investor'}</span>!
              </h2>
            </div>
          )}
        </motion.section>
