...
// import { Phone, Instagram, Briefcase, Users, Mail, Award, Link2, Edit } from 'lucide-react';
// import { FaTwitter, FaLinkedin, FaGithub, FaFacebook, FaWhatsapp } from 'react-icons/fa';
...
//             <div className="absolute -bottom-16 left-8">
//               <div className="h-32 w-32 rounded-full border-4 border-white dark:border-gray-800 bg-white dark:bg-gray-700 flex items-center justify-center shadow-xl">
//                 <div className="text-5xl font-light">👤</div>
//               </div>
//             </div>
//             <button 
//                     onClick={() => router.push(`/investor/settings`)}
//               className="absolute top-4 right-4 bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm px-4 py-2 rounded-full flex items-center shadow-md hover:bg-white dark:hover:bg-gray-600 transition-colors"
//             >
...
//                 <div>
//                   <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{profile.full_name}</h1>
//                   <p className="text-lg text-indigo-600 dark:text-indigo-400 mt-2 font-medium">{profile.role}</p>
//                 </div>
//               </div>
//               <p className="text-gray-500 dark:text-gray-400 mt-4 leading-relaxed">
//                 {profile.bio || "Passionate professional with a drive for excellence. Let's connect and collaborate!"}
//               </p>
//             </div>
...
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//               {/* About Section */}
//               <div className="bg-gray-50/50 dark:bg-gray-700/50 p-6 rounded-xl border border-gray-100 dark:border-gray-700">
//                 <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4 flex items-center">
//                   <Briefcase className="mr-2 text-indigo-600 dark:text-indigo-400" />
//                   Professional Info
//                 </h2>
//                 <div className="space-y-4">
//                   <div>
//                     <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Sector</p>
//                     <p className="text-gray-800 dark:text-gray-200 font-medium mt-1">{profile.sector}</p>
//                   </div>
//                   <div>
//                     <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Role</p>
//                     <p className="text-gray-800 dark:text-gray-200 font-medium mt-1">{profile.role}</p>
//                   </div>
//                 </div>
//               </div>
...
//                     <p className="text-gray-800 dark:text-gray-200 font-medium mt-1">{profile.email}</p>
//                   </div>
//                   <div>
//                     <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Phone</p>
//                     <p className="text-gray-800 dark:text-gray-200 font-medium mt-1">{profile.number}</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                     target="_blank" 
//                     rel="noopener noreferrer"
//                     className="flex items-center px-4 py-2 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/50 transition-all border border-green-100 dark:border-green-900/50 hover:shadow-sm"
//                   >
//                     <FaWhatsapp className="mr-2 text-green-600 dark:text-green-400" />
...
//                     target="_blank" 
//                     rel="noopener noreferrer"
//                     className="flex items-center px-4 py-2 bg-pink-50 dark:bg-pink-900/30 text-pink-700 dark:text-pink-300 rounded-lg hover:bg-pink-100 dark:hover:bg-pink-900/50 transition-all border border-pink-100 dark:border-pink-900/50 hover:shadow-sm"
//                   >
//                     <Instagram className="mr-2 text-pink-600 dark:text-pink-400" />
...
//                     target="_blank" 
//                     rel="noopener noreferrer"
//                     className="flex items-center px-4 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-all border border-blue-100 dark:border-blue-900/50 hover:shadow-sm"
//                   >
//                     <FaTwitter className="mr-2 text-blue-600 dark:text-blue-400" />
...
//                     target="_blank" 
//                     rel="noopener noreferrer"
//                     className="flex items-center px-4 py-2 bg-gray-50 dark:bg-gray-700/30 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-all border border-gray-100 dark:border-gray-700/50 hover:shadow-sm"
//                   >
//                     <FaGithub className="mr-2" />
